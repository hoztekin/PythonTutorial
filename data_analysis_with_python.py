...
plt.title('Sınıflara Göre Yolcu Sayısı')
plt.show()

sns.barplot(x="class", y="survived",  hue="who", data=df, palette='pastel')

sns.countplot(data=df, y='class', palette='pastel')
plt.title('Sınıflara Göre Yolcu Sayısı')
plt.show()

sns.displot(df.survived, kde=False)
plt.show()
