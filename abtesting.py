...
# Seed, rastgele sayı üretiminde tekrarlanabilirlik (reproducibility) sağlamak için kullanılır.
np.random.seed(115)
...
# Güven aralığı sms apiden DescrStatsW metotu
...
# shapiro değikenin dağılımın normal olup olmadığını kontrol eder
...
# levene fonksiyonu varyans homojenliği varsayımının sağlanıp sağlanmadığını kontrol eder
